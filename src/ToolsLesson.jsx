...
export default function ToolsLesson(){return <><p className="eyebrow">06 / 統計解析を実施する方法</p><h1>統計解析を実施する方法</h1><p className="lede">同じ解析でも、画面で操作する方法と、コードを書く方法があります。知りたいこととデータを整理した上で、必要な手法を実行できる道具を選びます。</p>
